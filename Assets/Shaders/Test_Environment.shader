...
Shader "BunjesFX/Test_Environment"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_BrightColor("Bright Color", Color) = (0.6698113,0.6698113,0.6698113,0)
		_DarkColor("Dark Color", Color) = (0.2641509,0.2641509,0.2641509,0)
		_IsUsingSeparateTiling("IsUsingSeparateTiling", Range( 0 , 1)) = 0
		_IsUsingSeparateOffset("IsUsingSeparateOffset", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult49 = (float2(_Tiling_Universal , _Tiling_Universal));
				float2 lerpResult50 = lerp( appendResult49 , _TilingSeparate , _IsUsingSeparateTiling);
				float2 appendResult64 = (float2(_Offset_Universal , _Offset_Universal));
				float2 lerpResult61 = lerp( appendResult64 , _OffsetSeparate , _IsUsingSeparateOffset);
				float2 texCoord14 = IN.ase_texcoord3.xy * lerpResult50 + lerpResult61;
				float temp_output_21_0 = saturate( pow( ( 2.0 * frac( texCoord14.x ) ) , 100000.0 ) );
				float UV_Left_Half39 = ( 1.0 - temp_output_21_0 );
				float temp_output_26_0 = saturate( pow( ( frac( texCoord14.y ) * 2.0 ) , 100000.0 ) );
				float UV_Bottom_Half38 = ( 1.0 - temp_output_26_0 );
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.CommentaryNode;66;-2531.126,258.5829;Inherit;False;2028.551;733.8304;UVs;29;14;15;16;21;36;25;26;37;27;38;19;39;17;18;54;24;23;55;22;50;51;49;61;64;12;65;48;63;62;UVs;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;46;474.3,242.5999;Inherit;False;676.1996;478.7997;Coloring;3;35;32;34;Coloring;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;44;-442.452,238.7041;Inherit;False;828.8519;585.5963;Composition;7;28;43;42;40;41;30;31;Composition;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;28;-109.0323,324.0406;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;43;-377.452,288.7041;Inherit;False;39;UV_Left_Half;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;42;-392.452,379.7041;Inherit;False;38;UV_Bottom_Half;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;40;-364.852,529.1044;Inherit;False;36;UV_Right_Half;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;21;-1130.001,403.6;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;36;-909.2758,397.8832;Inherit;False;UV_Right_Half;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;25;-1367.001,635.5999;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;26;-1117.501,636.0999;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;37;-944.2756,631.8831;Inherit;False;UV_Top_Half;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;27;-944.0978,726.454;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;-757.2748,721.3831;Inherit;False;UV_Bottom_Half;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;19;-907.8546,313.7407;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;39;-726.5747,308.5829;Inherit;False;UV_Left_Half;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-1517.001,376.6;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-1671.001,317.6;Inherit;False;Constant;_Float1;Float 1;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;54;-1662.537,400.6736;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-1534.334,633.9332;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-1544.334,759.9332;Inherit;False;Constant;_Float3;Float 0;2;0;Create;True;0;0;0;False;0;False;100000;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;55;-1670.537,633.6736;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1679.334,710.9332;Inherit;False;Constant;_Float2;Float 1;2;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;50;-2087.126,402.1846;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;51;-2406.126,549.1846;Inherit;False;Property;_IsUsingSeparateTiling;IsUsingSeparateTiling;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;54;0;14;1
WireConnection;24;0;55;0
WireConnection;24;1;22;0
WireConnection;55;0;14;2
